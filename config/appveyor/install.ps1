...
$Dependencies = "PyYAML cffi cryptography dfdatetime dfvfs dfwinreg dtfabric idna libbde libcreg libewf libfsapfs libfsext libfshfs libfsntfs libfsxfs libfvde libfwnt libfwsi libluksde libqcow libregf libsigscan libsmdev libsmraw libvhdi libvmdk libvshadow libvslvm mock pbr pytsk3 six"
