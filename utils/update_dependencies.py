...
class DPKGControlWriter(DependencyFileWriter):
  ...
  _FILE_HEADER = [
      ...
      u'Homepage: https://github.com/libyal/winreg-kb',
      u'']

  _PYTHON2_PACKAGE_HEADER = [
      u'Package: python-winregrc',
      u'Architecture: all']

  _PYTHON2_PACKAGE_FOOTER = [
      u'Description: Python 2 module for Windows Registry resources (winregrc)',
      u' winregrc is a Python module part of winreg-kb to allow reuse of',
      u' Windows Registry Resources.',
      u'']

  _PYTHON3_PACKAGE_HEADER = [
      u'Package: python3-winregrc',
      u'Architecture: all']

  _PYTHON3_PACKAGE_FOOTER = [
      u'Description: Python 3 module for Windows Registry resources (winregrc)',
      u' winregrc is a Python module part of winreg-kb to allow reuse of',
      u' Windows Registry Resources.',
      u'']
