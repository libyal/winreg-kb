...
class TaskCacheCollectorTest(test_lib.BaseTestCase):
    ...
    def _CreateTestRegistry(self):
        ...
        value_data = "{8905ECD8-016F-4DC2-90E6-A5F1FA6A841A}\x00".encode("utf-16-le")
        registry_value = dfwinreg_fake.FakeWinRegistryValue(
        ...
        value_data = "{F93C7104-998A-4A38-B935-775A3138B3C3}\x00".encode("utf-16-le")
        registry_value = dfwinreg_fake.FakeWinRegistryValue(
            "Id", data=value_data, data_type=dfwinreg_definitions.REG_SZ
        )
        registry_key.AddValue(registry_value)
        ...
        value_data = "{FE7B674F-2430-40A1-9162-AFC3727E3DC3}\x00".encode("utf-16-le")
        registry_value = dfwinreg_fake.FakeWinRegistryValue(
            "Id", data=value_data, data_type=dfwinreg_definitions.REG_SZ
        )
        registry_key.AddValue(registry_value)
    ...
    def _CreateTestRegistryEmpty(self):
        ...
        registry_file.AddKeyByPath(
            "\\Microsoft\\Windows NT\\CurrentVersion\\Schedule\\TaskCache", registry_key
        )
