...
class StdoutWriter(output_writers.StdoutOutputWriter):
    ...
    def WriteKnownFolder(self, known_folder, windows_versions):
        ...
        if known_folder.localized_display_name:
            ...
            print(f'localized_display_name: "{known_folder.localized_display_name:s}"')
...
def Main():
    ...
    argument_parser = argparse.ArgumentParser(
        description=("Extracts Windows known folders from the Windows Registry.")
    )
    ...
    for source_definition in source_definitions:
        ...
        for known_folder in collector_object.Collect(scanner.registry):
            ...
            if not existing_known_folder:
                ...
                and known_folder.display_name != existing_known_folder.display_name
                and known_folder.display_name
                not in (existing_known_folder.alternate_display_names)
            ):
