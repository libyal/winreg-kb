...
def Main():
    ...
    argument_parser = argparse.ArgumentParser(
        description=("Extracts the system information from the Windows Registry.")
    )
    ...
    if not result:
        ...
        output_writer.WriteValue(
            "Product identifier", collector_object.system_information.product_identifier
        )
        ...
        output_writer.WriteValue(
            "Registered owner", collector_object.system_information.registered_owner
        )
