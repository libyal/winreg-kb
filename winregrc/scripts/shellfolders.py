...
def Main():
    ...
    argument_parser = argparse.ArgumentParser(
        description=("Extracts the shell folder identifiers from the Windows Registry.")
    )
    ...
    for source_definition in source_definitions:
        ...
        collector_object = shellfolders.ShellFoldersCollector(debug=options.debug)
        ...
        for shell_folder in collector_object.Collect(scanner.registry):
            ...
            if not existing_shell_folder:
                ...
                shell_folder.name
                and shell_folder.name != existing_shell_folder.name
                and shell_folder.name not in existing_shell_folder.alternate_names
            ):
