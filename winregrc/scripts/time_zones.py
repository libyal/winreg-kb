...
class CSVFileWriter(output_writers.OutputWriter):
    ...
    def Open(self):
        ...
        """
        # TODO: use 'wt' instead of 'at'
        # pylint: disable=consider-using-with
        self._file_object = open(self._path, "at", encoding="utf-8")
        return 0
...
def Main():
    ...
    argument_parser = argparse.ArgumentParser(
        description=("Extracts time zone information for the Windows Registry.")
    )
    ...
    argument_parser.add_argument(
        ...
        dest="csv_file",
        action="store",
        metavar="time_zones.csv",
        default=None,
        help="path of the CSV file to write to.",
    )
