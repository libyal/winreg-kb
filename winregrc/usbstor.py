...
class USBStorageDeviceCollector(data_format.BinaryDataFormat):
    ...
    _USBSTOR_KEY_PATH = "HKEY_LOCAL_MACHINE\\System\\CurrentControlSet\\Enum\\USBSTOR"
    ...
    def _GetStringValueFromKey(self, registry_key, value_name, default_value=None):
                ...
                for property_set_key in properties_key.GetSubkeys():
                    for property_key in property_set_key.GetSubkeys():
                        for property_value_key in property_key.GetSubkeys():
                            ...
                            storage_device_property.value_type = (
                                self._GetPropertyValueType(property_value_key)
                            )
