...
class SingleFileWindowsRegistryFileReader(dfwinreg_interface.WinRegistryFileReader):
...
class WindowsRegistryVolumeScannerMediator(dfvfs_command_line.CLIVolumeScannerMediator):
    ...
    def _PrintUsernames(self, usernames):
        ...
        table_view = dfvfs_command_line.CLITabularTableView(column_names=column_names)
