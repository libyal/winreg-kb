...
class EventLogProvidersCollector(interface.WindowsRegistryKeyCollector):
    ...
    def _CollectEventLogProviders(self, services_eventlog_key, winevt_publishers_key):
        ...
        for event_log_provider in self._CollectEventLogProvidersFromServicesKey(
            ...
            if existing_event_log_provider:
                if (
                    provider_identifier
                    and provider_identifier != existing_event_log_provider.identifier
                ):
    ...
    def Collect(self, registry):
        ...
        services_eventlog_key = registry.GetKeyByPath(self._SERVICES_EVENTLOG_KEY_PATH)
        winevt_publishers_key = registry.GetKeyByPath(self._WINEVT_PUBLISHERS_KEY_PATH)
